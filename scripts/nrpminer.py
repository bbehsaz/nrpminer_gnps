...
from scripts.create_putative_nrp_database import *
...
def get_parser():
    ...
    parser.add_argument("--maxmod", dest="maxmod", help='Maximum mass modification to consider', default=0,type=float)
    parser.add_argument("--minAdomainscore", dest="minAdomainscore", help='NRPs with minimum A-domain score', default=50,type=int)
    parser.add_argument("--topAA", dest="topAA", help='Maximum rank of amino acids considerd for each A-domain', default=3,type=int)
...
if __name__ == "__main__":
    ...
    #### Use antiSMASH generated resutls to generated core NRPs ... 
    if not dbpremade:
        ...
        final_nrps_info= create_putative_nrp_dataset(args.antismash_resdir, allFilteredSpecMasses,NRPminerPath,rankThreshold,args.delete_orfs,args.delete_aminos,args.topAA,args.minAdomainscore,maxMod)
        nrps2check = []
